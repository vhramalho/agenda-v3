...
| Sem retornar | 4 | B | não | lista filtrada por bucket exato de dias (2026-06-29) | — | segmented "+N dias" em duas linhas, 5 buckets (2026-06-29) | não (card de insight do topo removido em 2026-06-29); ganhou "✎ Editar" no header (2026-06-29) — header passou a ser montado manualmente (igual Serviços/Formas de pagamento/Intervalos) em vez do `js-header-mount` compartilhado, porque agora precisa de uma ação no terceiro slot |
