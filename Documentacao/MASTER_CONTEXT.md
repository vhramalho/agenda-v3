...
| (detalhe) cards de período (ano) | nas 3 páginas de ranking completas (Ranking, Ranking de serviços, pendentes-devedores), adicionado em 2026-06-29: filtra por ano calendário em vez de janela rolante (12 meses / sem filtro / 6 meses, respectivamente) — **os teasers** dessas mesmas listas (Clientes "Ranking", Serviços "Mais realizados", Pendentes "Devedores") **não mudaram**, continuam com a janela rolante/sem filtro de antes; o seletor de ano é só nas telas-destino completas | | | | | | |
