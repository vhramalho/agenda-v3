...
function renderizarNegocioPerfil() {
  ...
  qs("#js-perfil-estabelecimento").textContent = config.nomeEstabelecimento || "Nenhum nome cadastrado";
  qs("#js-perfil-profissional").textContent = config.nomeProfissional || "Nenhum nome cadastrado";
  qs("#js-perfil-endereco").textContent = config.endereco || "Nenhum endereço cadastrado";
  qs("#js-perfil-link-mapa").textContent = config.linkMapa || "Gerado automaticamente pelo endereço";
}
